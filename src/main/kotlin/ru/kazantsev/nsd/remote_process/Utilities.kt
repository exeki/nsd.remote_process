...
class Utilities {
    companion object {
         ...
         */
        @JvmStatic
        fun checkRpcResponse(response: RpcResponseDto, notNull: Boolean): RpcResponseDto {
        ...
        @JvmStatic
        fun checkRpcResponse(response: RpcResponseDto): RpcResponseDto {
            return checkRpcResponse(response, false)
        }
